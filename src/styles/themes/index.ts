...
const themes = [
  {
    ...
    primary_button_fill: '#108ee9',
    primary_button_fill_tap: '#0e80d2',

    ghost_button_color: '#108ee9',    // 同时应用于背景、文字颜色、边框色
    ghost_button_fill_tap: `${'#108ee9'}99`, // alpha 60%  https://codepen.io/chriscoyier/pen/XjbzAW
    ...
    // segmented_control
    segmented_control_color: '#108ee9',  // 同时应用于背景、文字颜色、边框色
    segmented_control_height: 27,
    segmented_control_fill_tap: `${'#108ee9'}10`,
